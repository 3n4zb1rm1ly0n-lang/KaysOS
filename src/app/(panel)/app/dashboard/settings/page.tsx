...
import { FileSpreadsheet, FileText, Download, Loader2, Database, Tag, Plus, Trash2, Settings2, AlertTriangle, Globe } from 'lucide-react';
        ...
        if (error) {
            setSiteNotice(
                error.message.includes('site_content')
                    ? `Kayıt başarısız: ${error.message}. add_showcase_and_site_content.sql çalıştırın.`
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
            ...
            <div className="border rounded-xl bg-card overflow-hidden ring-1 ring-blue-500/20">
                ...
                <div className="p-6 space-y-4 max-w-2xl">
                    ...
                    {siteNotice && (
                        <p className="text-sm text-primary">{siteNotice}</p>
                    )}
                    <div>
                    ...
                    <div>
                        <label className="block text-xs text-muted-foreground mb-1">İletişim e-posta</label>
                        <input
                            type="email"
                    ...
                    <div>
                        <label className="block text-xs text-muted-foreground mb-1">İletişim notu</label>
                        <textarea
                            rows={2}
